...
function(streamer_print_configuration_summary)
  ...
  streamer_status("  USE_MXNET         : " ${USE_MXNET} THEN "Yes" ELSE "No")
  streamer_status("  USE_GIE           : " ${USE_GIE} THEN "Yes" ELSE "No")
  streamer_status("  USE_FP16          : " ${USE_FP16} THEN "Yes" ELSE "No")
  ...
  streamer_status("  Eigen             :   Yes (ver. ${EIGEN3_VERSION}, ${EIGEN3_INCLUDE_DIR})")
  streamer_status("  GStreamer         :   Yes (${GSTREAMER_LIBRARIES})")
  streamer_status("  GStreamer-app     :   Yes (${GSTREAMER_APP_LIBRARIES})")
  streamer_status("  glog              :   Yes (${GLOG_LIBRARIES})")
  ...
  list(GET HDF5_LIBRARIES 0 TMP_OUT)
  streamer_status("  HDF5              : " HDF5_FOUND THEN "Yes (ver. ${HDF5_VERSION}, ${TMP_OUT})" ELSE "No")
