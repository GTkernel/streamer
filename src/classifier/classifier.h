...
class Classifier {
 public:
   ...
   */
  Classifier(const string &model_desc, const string &model_params,
  ...
  /**
   * // TODO: May want to refactor it, expose a public method only for a
   * specific optimization seems terrible.
   * @brief Get the size of the input buffer, used for video pipeline to
   * preprocess image frames.
